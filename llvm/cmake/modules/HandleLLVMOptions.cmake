...
if ( LLVM_COMPILER_IS_GCC_COMPATIBLE AND LLVM_ENABLE_MODULES )
  ...
  list(APPEND module_flags "SHELL:-Xclang -fmodules-cache-missing=$<IF:$<BOOL:$<TARGET_PROPERTY:LLVM_BUILD_MODULES>>,build,include>")
  ...
  if (CXX_SUPPORTS_MODULES)
    list(JOIN module_flags $<SEMICOLON> module_flags)
    set(module_flags $<$<AND:$<COMPILE_LANGUAGE:CXX>,$<NOT:$<BOOL:$<TARGET_PROPERTY:LLVM_DISABLE_MODULES>>>>:${module_flags}>)
    add_compile_options(${module_flags})
  else()
