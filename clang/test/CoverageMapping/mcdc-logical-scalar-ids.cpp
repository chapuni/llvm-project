...
// CHECK: Decision,File 0, 5:17 -> 5:23 = M:0, C:2
// CHECK: Branch,File 0, 5:17 -> 5:18 = #1, (#0 - #1) [1,2,0]
// CHECK: Branch,File 0, 5:22 -> 5:23 = #2, (#1 - #2) [2,0,0]
// CHECK: Decision,File 0, 6:17 -> 6:28 = M:1, C:3
// CHECK: Branch,File 0, 6:17 -> 6:18 = #5, (#0 - #5) [1,3,0]
// CHECK: Branch,File 0, 6:22 -> 6:23 = #6, (#5 - #6) [3,2,0]
// CHECK: Branch,File 0, 6:27 -> 6:28 = #4, (#3 - #4) [2,0,0]
// CHECK: Decision,File 0, 7:17 -> 7:33 = M:2, C:4
// CHECK: Branch,File 0, 7:17 -> 7:18 = #11, (#0 - #11) [1,4,0]
...
// CHECK: Decision,File 0, 8:17 -> 8:38 = M:4, C:5
// CHECK: Branch,File 0, 8:17 -> 8:18 = #19, (#0 - #19) [1,5,0]
...
// CHECK: Decision,File 0, 9:17 -> 9:43 = M:8, C:6
// CHECK: Branch,File 0, 9:17 -> 9:18 = #29, (#0 - #29) [1,6,0]
...
// CHECK: Decision,File 0, 40:17 -> 40:23 = M:0, C:2
// CHECK: Branch,File 0, 40:17 -> 40:18 = (#0 - #1), #1 [1,0,2]
// CHECK: Branch,File 0, 40:22 -> 40:23 = (#1 - #2), #2 [2,0,0]
// CHECK: Decision,File 0, 41:17 -> 41:28 = M:1, C:3
// CHECK: Branch,File 0, 41:17 -> 41:18 = (#0 - #5), #5 [1,0,3]
// CHECK: Branch,File 0, 41:22 -> 41:23 = (#5 - #6), #6 [3,0,2]
// CHECK: Branch,File 0, 41:27 -> 41:28 = (#3 - #4), #4 [2,0,0]
// CHECK: Decision,File 0, 42:17 -> 42:33 = M:2, C:4
// CHECK: Branch,File 0, 42:17 -> 42:18 = (#0 - #11), #11 [1,0,4]
...
// CHECK: Decision,File 0, 43:17 -> 43:38 = M:4, C:5
// CHECK: Branch,File 0, 43:17 -> 43:18 = (#0 - #19), #19 [1,0,5]
...
// CHECK: Decision,File 0, 44:17 -> 44:43 = M:8, C:6
// CHECK: Branch,File 0, 44:17 -> 44:18 = (#0 - #29), #29 [1,0,6]
...
// CHECK:  Decision,File 0, 76:17 -> 76:23 = M:0, C:2
// CHECK:  Branch,File 0, 76:17 -> 76:18 = (#0 - #1), #1 [1,0,2]
// CHECK:  Branch,File 0, 76:22 -> 76:23 = (#1 - #2), #2 [2,0,0]
// CHECK:  Decision,File 0, 77:17 -> 77:30 = M:1, C:3
// CHECK:  Branch,File 0, 77:17 -> 77:18 = #3, (#0 - #3) [1,2,0]
// CHECK:  Branch,File 0, 77:23 -> 77:24 = (#3 - #4), #4 [2,0,3]
// CHECK:  Branch,File 0, 77:28 -> 77:29 = (#4 - #5), #5 [3,0,0]
// CHECK:  Decision,File 0, 78:17 -> 78:37 = M:2, C:4
// CHECK:  Branch,File 0, 78:18 -> 78:19 = (#0 - #7), #7 [1,2,3]
...
// CHECK:  Decision,File 0, 79:17 -> 79:42 = M:4, C:5
// CHECK:  Branch,File 0, 79:17 -> 79:18 = #12, (#0 - #12) [1,3,0]
...
// CHECK:  Decision,File 0, 80:17 -> 80:49 = M:8, C:6
// CHECK:  Branch,File 0, 80:18 -> 80:19 = (#0 - #19), #19 [1,3,4]
