...
// CHECK:  Decision,File 0, 4:7 -> 4:13 = M:0, C:2
// CHECK:  Branch,File 0, 4:7 -> 4:8 = #2, (#0 - #2) [1,2,0]
// CHECK:  Branch,File 0, 4:12 -> 4:13 = #3, (#2 - #3) [2,0,0]
// CHECK:  Decision,File 0, 5:9 -> 5:20 = M:1, C:3
// CHECK:  Branch,File 0, 5:9 -> 5:10 = #7, (#1 - #7) [1,3,0]
// CHECK:  Branch,File 0, 5:14 -> 5:15 = #8, (#7 - #8) [3,2,0]
// CHECK:  Branch,File 0, 5:19 -> 5:20 = #6, (#5 - #6) [2,0,0]
// CHECK:  Decision,File 0, 6:11 -> 6:27 = M:2, C:4
// CHECK:  Branch,File 0, 6:11 -> 6:12 = #14, (#4 - #14) [1,4,0]
...
// CHECK:  Decision,File 0, 7:13 -> 7:34 = M:4, C:5
// CHECK:  Branch,File 0, 7:13 -> 7:14 = #23, (#9 - #23) [1,5,0]
...
// CHECK:  Decision,File 0, 8:16 -> 8:42 = M:8, C:6
// CHECK:  Branch,File 0, 8:16 -> 8:17 = #34, (#16 - #34) [1,6,0]
...
// CHECK:  Decision,File 0, 40:7 -> 40:13 = M:0, C:2
// CHECK:  Branch,File 0, 40:7 -> 40:8 = (#0 - #2), #2 [1,0,2]
// CHECK:  Branch,File 0, 40:12 -> 40:13 = (#2 - #3), #3 [2,0,0]
// CHECK:  Decision,File 0, 41:9 -> 41:20 = M:1, C:3
// CHECK:  Branch,File 0, 41:9 -> 41:10 = (#1 - #7), #7 [1,0,3]
// CHECK:  Branch,File 0, 41:14 -> 41:15 = (#7 - #8), #8 [3,0,2]
// CHECK:  Branch,File 0, 41:19 -> 41:20 = (#5 - #6), #6 [2,0,0]
// CHECK:  Decision,File 0, 42:11 -> 42:27 = M:2, C:4
// CHECK:  Branch,File 0, 42:11 -> 42:12 = (#4 - #14), #14 [1,0,4]
...
// CHECK:  Decision,File 0, 43:13 -> 43:34 = M:4, C:5
// CHECK:  Branch,File 0, 43:13 -> 43:14 = (#9 - #23), #23 [1,0,5]
...
// CHECK:  Decision,File 0, 44:16 -> 44:42 = M:8, C:6
// CHECK:  Branch,File 0, 44:16 -> 44:17 = (#16 - #34), #34 [1,0,6]
...
// CHECK:  Decision,File 0, 76:7 -> 76:13 = M:0, C:2
// CHECK:  Branch,File 0, 76:7 -> 76:8 = (#0 - #2), #2 [1,0,2]
// CHECK:  Branch,File 0, 76:12 -> 76:13 = (#2 - #3), #3 [2,0,0]
// CHECK:  Decision,File 0, 77:9 -> 77:22 = M:1, C:3
// CHECK:  Branch,File 0, 77:9 -> 77:10 = #5, (#1 - #5) [1,2,0]
// CHECK:  Branch,File 0, 77:15 -> 77:16 = (#5 - #6), #6 [2,0,3]
// CHECK:  Branch,File 0, 77:20 -> 77:21 = (#6 - #7), #7 [3,0,0]
// CHECK:  Decision,File 0, 78:11 -> 78:31 = M:2, C:4
// CHECK:  Branch,File 0, 78:12 -> 78:13 = (#4 - #10), #10 [1,2,3]
...
// CHECK:  Decision,File 0, 79:13 -> 79:38 = M:4, C:5
// CHECK:  Branch,File 0, 79:13 -> 79:14 = #16, (#8 - #16) [1,3,0]
...
// CHECK:  Decision,File 0, 80:15 -> 80:47 = M:8, C:6
// CHECK:  Branch,File 0, 80:16 -> 80:17 = (#14 - #24), #24 [1,3,4]
