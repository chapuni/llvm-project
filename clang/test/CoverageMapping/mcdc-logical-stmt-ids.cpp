...
// CHECK-LABEL:  Decision,File 0, 4:7 -> 4:13 = M:4, C:2
// CHECK-NEXT:  Branch,File 0, 4:7 -> 4:8 = #2, (#0 - #2) [1,2,0]
// CHECK:  Branch,File 0, 4:12 -> 4:13 = #3, (#2 - #3) [2,0,0]
// CHECK-LABEL:  Decision,File 0, 5:9 -> 5:20 = M:12, C:3
...
// CHECK-LABEL:  Decision,File 0, 6:11 -> 6:27 = M:28, C:4
...
// CHECK-LABEL:  Decision,File 0, 7:13 -> 7:34 = M:60, C:5
...
// CHECK-LABEL:  Decision,File 0, 8:16 -> 8:42 = M:124, C:6
...
// CHECK-LABEL:  Decision,File 0, 40:7 -> 40:13 = M:4, C:2
// CHECK-NEXT:  Branch,File 0, 40:7 -> 40:8 = (#0 - #2), #2 [1,0,2]
// CHECK:  Branch,File 0, 40:12 -> 40:13 = (#2 - #3), #3 [2,0,0]
// CHECK-LABEL:  Decision,File 0, 41:9 -> 41:20 = M:12, C:3
...
// CHECK-LABEL:  Decision,File 0, 42:11 -> 42:27 = M:28, C:4
...
// CHECK-LABEL:  Decision,File 0, 43:13 -> 43:34 = M:60, C:5
...
// CHECK-LABEL:  Decision,File 0, 44:16 -> 44:42 = M:124, C:6
...
// CHECK-LABEL:  Decision,File 0, 76:7 -> 76:13 = M:4, C:2
// CHECK-NEXT:  Branch,File 0, 76:7 -> 76:8 = (#0 - #2), #2 [1,0,2]
// CHECK:  Branch,File 0, 76:12 -> 76:13 = (#2 - #3), #3 [2,0,0]
// CHECK-LABEL:  Decision,File 0, 77:9 -> 77:22 = M:12, C:3
...
// CHECK-LABEL:  Decision,File 0, 78:11 -> 78:31 = M:28, C:4
// CHECK-NEXT:  File 0
...
// CHECK-LABEL:  Decision,File 0, 79:13 -> 79:38 = M:60, C:5
...
// CHECK-LABEL:  Decision,File 0, 80:15 -> 80:47 = M:124, C:6
// CHECK-NEXT:  File 0
